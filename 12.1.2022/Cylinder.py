...
In case the radius parameter is less than 0 it needs to set the radius
field value to 0.

Write the following methods (instance methods):
* Method named getRadius without any parameters, it needs to
...
The class needs to have one constructor with two parameters
radius and height both of type double.
...
* Method named getVolume without any parameters,
it needs to return the calculated volume.
...
circle=Circle(3.75)
print("{0:.2f} circle.radius: ". format(circle.getRadius()))
print("{0:.f} circle.area: ". format(circle.getArea()))
cylinder=Cylinder(5.55,7.25)
print("{0:.2f} cylinder.radius". format(cylinder.getRadius()))
print("{0:.2f} cylinder.height". format(cylinder.getHeight()))
print("{0:.2f} cylinder.area". format(cylinder.getArea()))
print("{0:.2f} cylinder.volume". format(cylinder.getVolume()))
